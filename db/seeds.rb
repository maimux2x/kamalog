...
rice_bowl = membership.pieces.find_or_initialize_by(title: 'お茶碗').tap {
...
dish = membership.pieces.find_or_initialize_by(title: 'お皿').tap {
...
cup = membership.pieces.find_or_initialize_by(title: 'マグカップ').tap {
...
cup.logs.find_or_initialize_by(title: '紐作りでマグカップ作り').tap {
  it.update! date: '2026-04-05', body: '好きな作家さんの作風を参考に作ってみる。'
}
...
base = membership.pieces.find_or_initialize_by(title: '花瓶').tap {
